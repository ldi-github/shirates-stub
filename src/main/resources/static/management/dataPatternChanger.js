$(function () {
    ...
    $("#reset").on("click", function (e) {
        ...
        var url = `http://${host}${href}` + location.search
    ...
    $("a[data-data-pattern-name]").on("click", function (e) {
        ...
        var host = this.host
        var requestUrl = `http://${host}/management/setDataPattern` + location.search
        var urlPath = $(this).parent().parent().attr("data-url-path")
        var dataPatternName = $(this).attr("data-data-pattern-name")
        $.get(requestUrl, {urlPathOrApiName: urlPath, dataPatternName: dataPatternName}, function (data) {
        });
